...
#b Decoder Only
#|  num=36,num_layers=12
#|1 num=64,num_layers=32

#num_hiddens/num_heads必须为整数
num, edition, data_size = 36, 'b1', 10000
num_hiddens, num_layers, dropout = num, 12, 0
batch_size, num_steps, pretrain_num_steps = 64, 16, 128
lrs, nums_epochs, device = [0.0005, 0.0001, 0.00001, 0.000002], [10000, 10000, 55000, 0], d2l.try_gpu(5)
...
pretrain_data_iter, pretrain_vocab = load_data_dairy(f'MyTransformers-{edition}.tokenizer', batch_size, 128)
